...
Patched by John Main <john@iris.ac>
Changes:
Ignores leading whitespace on tokens
...
public class CSVReader {
	...
	*/
	...
	/**
	* Reads the next line from the buffer, parses and returns as string.
	* 
	* @return a CSV string 
	* 
	* @throws IOException
	...
	private String[] parseLine(String nextLine) throws IOException
	{
		...
		do
		{
			...
			for (int i = 0; i < nextLine.length(); i++)
			{
				...
				if(!(sb.length() == 0 && nextLine.charAt(i) == ' '))
				{
	...
	* 
	* @return if there are more lines
	*/
